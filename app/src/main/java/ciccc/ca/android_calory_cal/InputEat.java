package com.dgcamp.ccal_cal_app;
...
//            write to DB
            ...
            Toast.makeText(this,"Ro'yxatga qo'shildi",Toast.LENGTH_LONG).show();

        }else {
            Toast.makeText(this,"Iltimos, mashq va yo'qolgan kaloriyalarni kiriting",Toast.LENGTH_LONG).show();
        }
    }
}
